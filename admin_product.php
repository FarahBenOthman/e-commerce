...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(mysqli_num_rows($select_product_name) >0){
        ...
        $insert_product = mysqli_query($conn, "INSERT INTO `products` (`name`, `price`, `product_detail`, `image`) VALUES
        ('$product_name', '$product_price', '$product_detail', '$image')") or die ('query failed');
        if($insert_product){
